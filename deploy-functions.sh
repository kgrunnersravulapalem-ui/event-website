...
echo ""
echo "firebase functions:config:set phonepe.client_id=\"YOUR_CLIENT_ID\""
echo "firebase functions:config:set phonepe.client_secret=\"YOUR_CLIENT_SECRET\""
...
echo "firebase functions:config:set webhook.username=\"YOUR_WEBHOOK_USERNAME\""
echo "firebase functions:config:set webhook.password=\"YOUR_WEBHOOK_PASSWORD\""
