...
exports.cleanupPendingPayments = void 0;
...
exports.cleanupPendingPayments = functions
    ...
    try {
        ...
        for (const doc of pendingTransactionsSnapshot.docs) {
            ...
            if (transactionData.registrationId) {
                ...
                if (regDoc.exists) {
                    ...
                    console.log(`Participant: ${(registrationData === null || registrationData === void 0 ? void 0 : registrationData.name) || 'Unknown'} (${(registrationData === null || registrationData === void 0 ? void 0 : registrationData.email) || 'N/A'})`);
                }
            }
            ...
            results.details.push({
                ...
                participantName: (registrationData === null || registrationData === void 0 ? void 0 : registrationData.name) || 'Unknown'
            });
        ...
        console.log(`${'='.repeat(80)}\n`);
        res.status(200).json(Object.assign({ success: true, message: 'One-time cleanup completed', timestamp: new Date().toISOString(), environment: config.environment }, results));
    }
    catch (error) {
...
//# sourceMappingURL=cleanupPendingPayments.js.map