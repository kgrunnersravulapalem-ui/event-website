...
exports.verifyPayment = functions.https.onRequest(async (req, res) => {
    ...
    try {
        ...
        if ((transactionData === null || transactionData === void 0 ? void 0 : transactionData.status) === 'COMPLETED' || (transactionData === null || transactionData === void 0 ? void 0 : transactionData.status) === 'CONFIRMED') {
        ...
        try {
            ...
            if ((transactionData === null || transactionData === void 0 ? void 0 : transactionData.status) === 'PENDING') {
                res.status(200).json({
                    success: true,
                    data: {
                        status: 'PENDING',
